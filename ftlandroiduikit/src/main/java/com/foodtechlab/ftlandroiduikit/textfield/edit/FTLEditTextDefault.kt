...
import com.foodtechlab.ftlandroiduikit.textfield.edit.FTLEditTextDefaultThemeManager
...
class FTLEditTextDefault @JvmOverloads constructor(
    ...
    private val viewThemeManager: ViewThemeManager<FTLEditTextDefaultTheme> =
        FTLEditTextDefaultThemeManager()
    private val job = SupervisorJob()
    override val coroutineContext: CoroutineContext
        get() = Dispatchers.Main + job
    private var ftlEditTextDefaultTheme: FTLEditTextDefaultTheme = viewThemeManager.lightTheme
    ...
    private val controlsColor: Int
        get() =
            ContextCompat.getColor(
                context, when {
                    isErrorEnabled -> ftlEditTextDefaultTheme.errorControlColor
                    !etInput.hasFocus() && !etInput.text.isNullOrEmpty() -> ftlEditTextDefaultTheme.defaultControlColor
                    isHintOnTop -> ftlEditTextDefaultTheme.activeControlColor
                    else -> ftlEditTextDefaultTheme.defaultControlColor
                }
            )
