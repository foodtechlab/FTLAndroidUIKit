...
import com.foodtechlab.ftlandroiduikit.button.radio.FTLRadioButtonThemeManager
import com.foodtechlab.ftlandroiduikit.common.DotsLine
import com.foodtechlab.ftlandroiduikit.textfield.route.FTLRouteTextViewThemeManager
import com.foodtechlab.ftlandroiduikit.textfield.section.FTLSectionTextViewTheme
import com.foodtechlab.ftlandroiduikit.textfield.section.FTLSectionTextViewThemeManager
...
class FTLRouteTextView @JvmOverloads constructor(
    ...
    private val viewThemeManager: ViewThemeManager<FTLRouteTextViewTheme> =
        FTLRouteTextViewThemeManager()
    val job = SupervisorJob()
    override val coroutineContext: CoroutineContext
        get() = Dispatchers.Main + job
    private var ftlRouteTextViewTheme = viewThemeManager.lightTheme
    ...
    var routeBackgroundColor = ContextCompat.getColor(
        context,
        ftlRouteTextViewTheme.routeBackgroundColor
    )
        set(value) {
            field = value
    ...
    @ColorInt
    var routeItemsColor =
        ContextCompat.getColor(context, ftlRouteTextViewTheme.routItemsColor)
        set(value) {
            field = value
    ...
    private fun TypedArray.setupRouteBackgroundColor() {
        viewThemeManager.lightTheme.routeBackgroundColor = getResourceId(
            R.styleable.FTLRouteTextView_routeBackgroundColorLight,
            viewThemeManager.lightTheme.routeBackgroundColor
        )
        viewThemeManager.darkTheme?.let {
            it.routeBackgroundColor = getResourceId(
                R.styleable.FTLRouteTextView_routeBackgroundColorDark,
                it.routeBackgroundColor
            )
        }
        launch {
            viewThemeManager.mapToViewData().collect { theme ->
